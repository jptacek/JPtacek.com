...
route to bypass this with ``$locationProvider.html5Mode(true)``. For our exampl,e the URL for a list will be
...
approach. This is done by creating a second route where we identify a parameter that we
