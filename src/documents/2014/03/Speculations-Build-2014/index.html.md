...
Microsoft’s Surface RT tablet.  In 2013, Build was held in San Francisco and Microsoft announced Windows 8.1 as as made available a preview
release for developers. Last year I took a [stab](http://www.jptacek.com/2013/06/Speculation-Microsoft-Build/) at
 speculating about Build 2013 and did pretty spectacularly bad. With Build 2014 a
...
has not been a 7-8 inch surface release to mimic the iPad Mini, the fastest growing tablet market. There also has not been a
...
phone platform? Edification would be great!
...
announcement of a Surface Mini. In general, except for the first Build, it is not a place where Microsoft is likely to announce new hardware.
...
###Azure###
Microsoft's Azure platform is amazing. The degree to which the Azure team can execute and release new features is dizzying. As somone
who is a big proponent of the cloud for organizations to embrace, and I spend time following the various platforms, it is hard to keep up
...
execute on the Microsoft One strategy, it is Satya. I am interested to see what happens next.
