(function() {
    ...
    angular
        .module('louApp')
        .controller('louCtrl', louCtrl)

    louCtrl.$inject = ['$scope'];

    function louCtrl($scope) {
        $scope.louDrops = louAlbums;
    }
}
)();
...
var louAlbums = {
    releases: [
        ...
        },
        {
            ...
            "image": "http://upload.wikimedia.org/wikipedia/en/f/f1/Loureedtransformer.jpeg",
        ...
        },
        {
            ...
            "image": "http://upload.wikimedia.org/wikipedia/en/6/65/Metal_machine_music.jpg",
            "producer": "Lou Reed",
            "label": "RCA"
        },
        {
