...
actual correct HTML at
[http://angularperiodic.azurewebsites.net/Demo05-ImageBindingWithLouReed/lou.html](http://angularperiodic.azurewebsites.net/Demo05-ImageBindingWithLouReed/lou.html)
until the I fix this.
...
<h3>Missing Images in Javascript Object</h3>
   ...
   <div id="louTable2"  ng-controller="louCtrl2" >
        <table class="table table-striped table-bordered table-hover table-condensed">
            <tr>
                <th>Album</th><th>Release</th><th>Producer</th><th>Label</th><th></th>
            </tr>
...
onerror by placing a default placeholder image for missing images.
 ...
 <h3>Resolve missing images</h3>
    <div id="louTable3"  ng-controller="louCtrl2" >
        <table class="table table-striped table-bordered table-hover table-condensed">
            <tr>
                <th>Album</th><th>Release</th><th>Producer</th><th>Label</th><th></th>
            </tr>
